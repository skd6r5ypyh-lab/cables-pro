...
function exportBackup(){
  const data={version:VERSION,exported:new Date().toISOString(),jobs:jobs(),customers:customers(),quotes:quotes(),diary:diary(),stock:stock(),engineers:engineers(),technicalRecords:technicalRecords(),assets:assets(),settings:storage.read('cp4_settings',{})};
