...
const emptyData={customers:[],jobs:[],quotes:[],customerNotes:[],equipment:[],batteryRecords:[],customerPhotos:[]};
...
function shell(body){
 return `<div class="app"><header><div class="brand"><img src="logo.png"><div><b>Cables Pro</b><small>Professional Intruder Alarm Edition</small></div></div><div class="version">V11</div></header><main>${body}</main>
