...
const emptyData={customers:[],jobs:[],quotes:[],invoices:[],stock:[],suppliers:[],jobMaterials:[],customerNotes:[],equipment:[],batteryRecords:[],customerPhotos:[]};
...
function shell(body){
 return `<div class="app"><header><div class="brand"><img src="logo.png"><div><b>Cables Pro</b><small>Professional Intruder Alarm Edition</small></div></div><div class="version">V12</div></header><main>${body}</main>
...
function home(){
 ...
 <button class="module" data-new-customer><div class="ico">👥</div><b>Add Customer</b><span>Save customer details for quick report completion.</span></button><button class="module" data-route="more"><div class="ico">£</div><b>Business Management</b><span>Quotes, invoices, stock, suppliers and profitability.</span></button></div>`;
}
function diary(){
